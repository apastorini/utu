...
4. Kali Linux: Distribuciones y Herramientas Esenciales
5. Instalación de Kali Linux en VirtualBox
6. Comandos de Linux y Docker para Pentesting
7. OWASP ZAP y Burp Suite: Análisis Profundo de Tráfico Web
8. Nikto: Escaneo de Vulnerabilidades Web
9. John the Ripper: Crackeo de Contraseñas
10. Pruebas de Denegación de Servicio
11. Ejemplo Práctico: 10 Vulnerabilidades Documentadas con Ciclo de Hacking

> **Nota:** Los conceptos de virtualización (VMs, hipervisores, contenedores) están en `semana_3_virtualizacion.md`
...
3. **Instalación de VirtualBox** y configuración básica
4. **Kali Linux** con herramientas detalladas: Nmap, SQLMap, John the Ripper
5. **Instalación de Kali** en múltiples configuraciones
6. **Comandos esenciales** de Linux y Docker
7. **OWASP ZAP y Burp Suite** para análisis profundo de tráfico
8. **Nikto** para escaneo de vulnerabilidades web
9. **John the Ripper** para crackeo de contraseñas
10. **Pruebas de DoS** básicas
