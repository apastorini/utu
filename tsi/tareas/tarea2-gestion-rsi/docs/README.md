# docs — Carpeta de trabajo del equipo (Tarea 2)
...
|---|---|---|
| `00-arquitectura.md` | nueva (arquitectura + modelo ER) | ☐ |
...
| `Muestras de exportaciones/` | MCU 5.0, BCU, URCDP, ISO, COBIT | ☐ |
| `evidencias/` | capturas, vídeos | ☐ |
